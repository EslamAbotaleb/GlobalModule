...
public extension String {
    ...
    func convertHtmlToAttributedStringWithCSS(font: UIFont? , csscolor: UIColor? , lineheight: Int, csstextalign: String) -> NSAttributedString? {
     ...
     func convertHtmlToAttributedStringWithCSSWithLimitation(font: UIFont? , csscolor: String , lineheight: Int, csstextalign: String, maxLength: Int) -> NSAttributedString? {
